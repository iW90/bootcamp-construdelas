public class Moeda {
    public static string Centavos(string valor)
    {
        ...
        else if (dezenaCent == 0 && unidadeCent == 1)
        {
            return Numeros.UnidadeDezena(unidadeCent, dezenaCent) + " CENTAVO";
        }
        else
        {
            return Numeros.UnidadeDezena(unidadeCent, dezenaCent) + " CENTAVOS";
        }
    }
